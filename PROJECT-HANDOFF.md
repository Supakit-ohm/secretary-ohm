...
32. **ธรรมนูญดีไซน์: ทุกหน้าต้องสเกลตามหน้า Home (ohm สั่ง 2026-08-26 หลังจบข้อ 24/2)** — ohm บอกว่า "หน้า home ลงตัวมาก อยากให้ทุกหน้าสเกลสัมพันธ์กับหน้าโฮม" · **ข้อนี้เป็นข้อบังคับของงานข้อ 24/3 เป็นต้นไปทุกข้อ ไม่ใช่งานแยก** อ่านข้อนี้ก่อนเริ่มรีดีไซน์ทุกหน้า
   ...
   **คิว (ข้อ 24): ~~3 Investments~~ ✅ → ~~4 Finance Overview~~ ✅ → ~~5 Debts~~ ✅ → ~~6 Tracker~~ ✅ → ~~7 Finance Review~~ ✅ → **8 Income+Expenses (ต่อไป — reskin เท่านั้น)** → 9 หน้าเล็กรวบทีเดียว → 10 มือถือ**
...
34. **ข้อ 24/4 เสร็จแล้ว: Finance Overview เป็น bento (2026-08-26)** — ต่อจากข้อ 33 ในเซสชันเดียวกัน (ohm สั่ง "ต่อไปเลย")
    ...
    **คอมโพเนนต์ที่เพิ่ม/รื้อ:**
    - **`FinDonutCard`** (ใหม่) — การ์ดโดนัทหมวดหมู่แบบ bento · **ห้ามเอาไปแทน `CategoryPieCard`** ตัวเดิมยังถูกใช้ในแท็บ Income (บรรทัด ~1776 เดิม) และ Expenses (~2420 เดิม) ที่ยังไม่ถึงคิว (ข้อ 24/8 และห้ามรื้อเป็น bento) — จงใจให้อยู่คู่กันชั่วคราว **พอทำข้อ 24/8 เสร็จค่อยลบ `CategoryPieCard` + CSS `.fin-pie-*` ทิ้ง**
