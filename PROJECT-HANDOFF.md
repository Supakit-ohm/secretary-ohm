...
> งานที่ยังไม่ได้ทำ (เรียงตามที่คุยไว้ท้ายข้อ 16): ~~**XIRR/ผลตอบแทน %ต่อปี**~~ ✅ **เสร็จแล้ว (2026-09-16, ข้อ 51)**, ~~**หน้าประวัติ DCA ต่อเหรียญ**~~ ✅ **เสร็จแล้ว (2026-09-16, ข้อ 52 — เพิ่มลบทีละงวดด้วย)** — ทั้งคู่ ohm ยังต้อง push · **ตั้งเป้าสัดส่วนพอร์ต** เช่น crypto ไม่เกิน 10%, **กราฟมูลค่าพอร์ตตามเวลา** (งานใหญ่ ต้องเปลี่ยน `investmentValues` เป็น history array — ดูข้อ 4.4)
