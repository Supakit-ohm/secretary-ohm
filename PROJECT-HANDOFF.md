...
> งานที่ยังไม่ได้ทำ (เรียงตามที่คุยไว้ท้ายข้อ 16): ~~**XIRR/ผลตอบแทน %ต่อปี**~~ ✅ **เสร็จแล้ว (2026-09-16, ข้อ 51)** จาก `h.buys[]`+`firstHeldDate` — ohm ยังต้อง push · **หน้าประวัติ DCA ต่อเหรียญ** (เก็บ `buys[]` ไว้แล้วแต่ยังไม่มี UI แสดงรายการย้อนหลัง), **ตั้งเป้าสัดส่วนพอร์ต** เช่น crypto ไม่เกิน 10%, **กราฟมูลค่าพอร์ตตามเวลา** (งานใหญ่ ต้องเปลี่ยน `investmentValues` เป็น history array — ดูข้อ 4.4)
