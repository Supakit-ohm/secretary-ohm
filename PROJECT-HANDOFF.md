...
อัปเดตล่าสุด: 2026-08-26 (ข้อ 23 = ล็อกชุดสีธีมใหม่ Dark Emerald + mockup ที่ `mockups/` · ohm ยืนยันว่า**จัดหมวด "อื่นๆ" ครบแล้ว** → ปัญหาข้อ 1 ในข้อ 5 ปิดได้ · ก่อนหน้านี้ 2026-08-25: ข้อ 20 หน้ายืนยัน Import + ข้อ 21 หมุดโปรเจกต์ **push แล้ว** · ข้อ 22 = รันเทสต์จริงย้อนหลัง 4 รอบ ผ่าน 43/43 ไม่มี runtime error)
