...
อัปเดตล่าสุด: 2026-08-23 (รื้อ UI หน้า Investments รอบใหญ่ตามสเปกที่คุยกับ ohm แล้ว — ดูข้อ 18 ท้ายไฟล์ **ยังไม่ได้ทดสอบเปิดจริง รอ ohm เปิดแอปเช็คก่อน push**)
...
|---|---|---|---|
| 1 | หมวด **"อื่นๆ" ~154,823 บาท** (เครื่องมือเดาหมวดเสร็จแล้ว 2026-08-22 ดูข้อ 5 — เหลือไล่กดจัด) เป็นก้อนใหญ่สุด (มาจาก CSV ที่ไม่มีคอลัมน์หมวด) | รีวิวบอกได้แค่ "ใช้เยอะ" แต่ไม่รู้เยอะกับอะไร | ใช้ `RecategorizeModal` ที่มีอยู่แล้วไล่จัดหมวด + เพิ่มกฎเดาหมวดจากคำในโน้ตตอน import |
...
| 5 | ไม่มีระบบ backup / export | localStorage หายคือหายหมด | เพิ่มปุ่ม Export/Import JSON |
...
3. **จัดหมวด "อื่นๆ"** ← ปลดล็อกให้ Review มีประโยชน์จริง
4. **หน้า Debts**
